...
echo "Setting environment for Chaos Experiments"
PUB_KEY_PATH=./dockerkey.pub
docker build -t 'indybase' --build-arg uid=$USER_ID --build-arg pub_key=${PUB_KEY_PATH} -f ${SCRIPT_DIR}/chaos.node.init.dockerfile $SCRIPT_DIR
