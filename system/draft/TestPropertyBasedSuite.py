...
class TestPropertyBasedSuite:
    ...
    @given(amount=strategies.integers(min_value=0, max_value=999999999999999),
           seqno=strategies.integers(min_value=0, max_value=999999999999999),
           signatures=strategies.text(ascii_letters, min_size=88, max_size=88),
           reqid=strategies.integers(min_value=1, max_value=999999999999999))
    @pytest.mark.asyncio
